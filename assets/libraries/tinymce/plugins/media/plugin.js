...
(function () {
    ...
    var getAudioHtml = function (data, audioTemplateCallback) {
      if (audioTemplateCallback) {
        ...
        return '<sounds controls="controls" src="' + data.source + '">' + (data.altsource ? '\n<source src="' + data.altsource + '"' + (data.altsourcemime ? ' type="' + data.altsourcemime + '"' : '') + ' />\n' : '') + '</sounds>';
      }
    };
    ...
    var setup$1 = function (editor) {
      editor.on('preInit', function () {
        ...
        global$8.each('video sounds iframe object'.split(' '), function (name) {
        ...
        editor.parser.addNodeFilter('iframe,video,sounds,object,embed,script', placeHolderConverter(editor));
